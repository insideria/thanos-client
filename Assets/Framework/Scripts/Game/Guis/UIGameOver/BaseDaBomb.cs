...
public class BaseDaBomb : MonoBehaviour {
    ...
    public static System.Action<float> StartEffectEvent;
...
//                 }
    ...
    {
        if (homeBase.IsSameCamp(EntityCampTypeEnum.A))
        {
        ...
        if (PlayerManager.Instance.LocalPlayer.EntityCamp == EntityCampTypeEnum.A)
        {
            posDest = targetA;
        }
        else
