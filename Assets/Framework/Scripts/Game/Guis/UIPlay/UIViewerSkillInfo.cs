...
public class UIViewerSkillInfo : MonoBehaviour {
    ...
    void OnEnable()
    {
        Instance = this;
        Init();
        EventCenter.AddListener<IPlayer>((Int32)GameEventEnum.GameEvent_AbsSkillInfo, AddHeroAbsorbSkill);//添加英雄吸附技能
        EventCenter.AddListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillInfo, InitHeroSkills);
        EventCenter.AddListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillUpLvChange, SkillUpgrade);
        EventCenter.AddListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillCDInfo, ChangeSkillCd);

    }
    void OnDisable()
    {
        Instance = null;
        EventCenter.RemoveListener<IPlayer>((Int32)GameEventEnum.GameEvent_AbsSkillInfo, AddHeroAbsorbSkill);
        EventCenter.RemoveListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillInfo, InitHeroSkills);
        EventCenter.RemoveListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillUpLvChange, SkillUpgrade);
        EventCenter.RemoveListener<IPlayer>((Int32)GameEventEnum.GameEvent_SkillCDInfo, ChangeSkillCd);
    }
    //skill slot
    class SkillSlot
    {
       ...
       public  void SetFuryEffect()
       {
           if (null == furyEffect)
           {
               ...
               ResourceItem furyEffectUnit = ResourcesManager.Instance.loadImmediate(GameDefine.GameConstDefine.FurySkillBtnEffect, ResourceType.PREFAB);
    ...
    void OnPress(int ie, bool isPress)
    {
        ...
        EventCenter.Broadcast<bool, SkillTypeEnum, IPlayer>((Int32)GameEventEnum.GameEvent_SkillDescribleType, false, SkillTypeEnum.SKILL_NULL, player);
    }
    ...
    void Update()
    {
        ...
        {
            EventCenter.Broadcast<bool, int, IPlayer>((Int32)GameEventEnum.GameEvent_SkillDescribleId, true, skillDic[player].GetSkillId(curSlot), player);
