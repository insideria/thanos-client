...
namespace Thanos.Ctrl
{
    public class PresonInfoCtrl : Singleton<PresonInfoCtrl>
    {
        ...
        public void Exit()
        {
            EventCenter.Broadcast((Int32)GameEventEnum.GameEvent_PresonInfoExit);
        }
        ...
        {
            HolyGameLogic.Instance.EmsgToss_AskChangeheaderId(headID);
        }

        public void ChangeNickName(string nickName)
        {
            HolyGameLogic.Instance.EmsgToss_AskChangeNickName(nickName);
        }
