...
namespace Thanos.GuideDate
{
    ...
    public class GuideToAdGuideTask : GuideTaskBase
    {
        ...
        {
            ResourceItem Unit = ResourcesManager.Instance.loadImmediate("Guide/UIGuideTwoBtn" , ResourceType.PREFAB);
        ...
        private void OnGoButtonClick()
        {
            ...
            Thanos.Ctrl.BattleCtrl.Instance.AskCreateGuideBattle(1001, GCToCS.AskCSCreateGuideBattle.guidetype.second);
            this.FinishTask();
        }
