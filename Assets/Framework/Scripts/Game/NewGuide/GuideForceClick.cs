...
namespace Thanos.GuideDate
{
    public class GuideForceClick : GuideTaskBase
    {
        ...
        {
            //EventCenter.AddListener<ButtonDragType>((Int32)GameEventEnum.GameEvent_PlayGuideDragEvent, OnGameObjectDragEvent);
        }
        ...
        {
            ResourceItem Unit = ResourcesManager.Instance.loadImmediate("Guide/" + mTaskInfo.PrefabName, ResourceType.PREFAB);
        ...
        private void LoadGuideEffect()
        {
            ...
            ResourceItem Unit = ResourcesManager.Instance.loadImmediate(mTaskInfo.GuideEffect, ResourceType.PREFAB);
        ...
        public override void ClearTask()
        {
            ...
            //{
            //    EventCenter.RemoveListener<ButtonDragType>((Int32)GameEventEnum.GameEvent_PlayGuideDragEvent, OnGameObjectDragEvent);  
            //}
