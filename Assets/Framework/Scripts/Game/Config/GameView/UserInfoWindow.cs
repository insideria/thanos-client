...
namespace Thanos.View
{
    public class UserInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_UserEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_UserExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_UserEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_UserExit, Hide);
        }
        ...
        public void CreateHead()
        {
            ...
            ResourceItem objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadGameHeroHead, ResourceType.PREFAB);
        ...
        {
            EventCenter.AddListener<ErrorCodeEnum>((Int32)GameEventEnum.AskComplementedRegisterInfo, RegisterResult);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<ErrorCodeEnum>((Int32)GameEventEnum.AskComplementedRegisterInfo, RegisterResult);
        }
        ...
        public override void OnEnable()
        {
            ...
            //IGuideTaskManager.Instance().AddTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideInputNickNameStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideSelectSexStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideSelectHeadStart, StartIGuideTask);
            //IGuideTaskManager.Instance().AddTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideCommitRegisterStart, StartIGuideTask);
            //IGuideTaskManager.Instance().SendTaskTrigger((Int32)GameEventEnum.GameEvent_UIGuideTriggerRegister);
        ...
        public override void OnDisable()
        {
            ...
            //IGuideTaskManager.Instance().RemoveTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideInputNickNameStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideSelectSexStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideSelectHeadStart, StartIGuideTask);
            //IGuideTaskManager.Instance().RemoveTaskStartListerner((Int32)GameEventEnum.GameEvent_UIGuideCommitRegisterStart, StartIGuideTask);
        }
        ...
        //void StartIGuideTask(GameEventEnum taskId)
        //{
        //    //List<BoxCollider> boxList = new List<BoxCollider>();
        //    List<GameObject> objList = new List<GameObject>();
        //    switch (taskId)
        //    {
        //        case (Int32)GameEventEnum.GameEvent_UIGuideInputNickNameEnd:
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            break;
        //        case (Int32)GameEventEnum.GameEvent_UIGuideSelectSexEnd:
        //            objList.Add(boySelect.gameObject);
        //            objList.Add(girlSelect.gameObject);
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            break;
        //        case (Int32)GameEventEnum.GameEvent_UIGuideSelectHeadEnd:
        //            objList.Add(nickNameInput.gameObject);
        //            objList.Add(btnDice.gameObject);
        //            for (int i = 0; i < headList.Count; i++)
        //            {
        ...
        //            }
        //            break;
        //        case (Int32)GameEventEnum.GameEvent_UIGuideCommitRegisterEnd:
        ...
        //{
        //    IGuideTaskManager.Instance().SendTaskEnd((Int32)GameEventEnum.GameEvent_UIGuideSelectSexEnd);
        //}
        ...
        void SelectHead(int ie, bool isDown)
        {
            ...
            IGuideTaskManager.Instance().SendTaskEnd((Int32)GameEventEnum.GameEvent_UIGuideSelectHeadEnd);
        }
        ...
        bool CheckNameInput()
        {
            ...
            if (!GameUtils.CheckName(nickNameInput.label.text))
            {
                ShowTip(invalideName);
                return false;
            }

            IGuideTaskManager.Instance().SendTaskEnd((Int32)GameEventEnum.GameEvent_UIGuideInputNickNameEnd);
            return true;
        }
        ...
        void SubmitRegister()
        {
            ...
            {
                noPass.gameObject.SetActive(true);
                MsgInfoManager.Instance.ShowMsg((int)ErrorTypeEnum.FillInNiceName);
                return;
            }
            if (!CheckNameInput())
            {
            ...
            IGuideTaskManager.Instance().SendTaskEnd((Int32)GameEventEnum.GameEvent_UIGuideCommitRegisterEnd);

            byte[] bytes = Encoding.UTF8.GetBytes(nickNameInput.label.text);
            HolyGameLogic.Instance.GameCompleteBaseInfo(SelectServerData.Instance.serverUin, bytes, Convert.ToInt32(spriteHead.spriteName), isBoy);
        }
