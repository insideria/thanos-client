...
namespace Thanos.View
{
    public class RoomWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RoomEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RoomExit, Hide);
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.RoomEnd, ShowRoomEnd);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.AddListener<ErrorCodeEnum>((Int32)GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
            EventCenter.AddListener<uint,string>((Int32)GameEventEnum.GameEvent_RecvChatMsg,ShowTalk);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.RoomEnd, ShowRoomEnd);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SeatPosUpdate, RrefreshSeat);
            EventCenter.RemoveListener<ErrorCodeEnum>((Int32)GameEventEnum.GameEvent_AskBeginBattleError, BeginBattleError);
            EventCenter.RemoveListener<uint, string>((Int32)GameEventEnum.GameEvent_RecvChatMsg, ShowTalk);
        }
       ...
       //效果
        ...
        void BeginBattleError(ErrorCodeEnum m_n32ErrorId)
        {
        ...
        void BtnEvent(int ie, bool pressed)
        {
            ...
            switch ((GameRoomBtn)ie)
            {
                ...
                case GameRoomBtn.LEAVEBATTLE:
                    ...
                    {
                        MsgInfoManager.Instance.ShowMsg((int)ErrorTypeEnum.CancelReady);
                    }
                    else
                    {
        ...
        void SendTalk(int index, bool isPress)
        {
            ...
            {
                MsgInfoManager.Instance.ShowMsg((int)ErrorTypeEnum.TalkSendNull);
                return;
            }
