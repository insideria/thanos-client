...
namespace Thanos.View
{
    public class UIGuideWindow : BaseWindow
    {
        ...
        {
            //EventCenter.AddListener((Int32)GameEventEnum.GameEvent_UIGuideEnter, Show);
            //EventCenter.AddListener((Int32)GameEventEnum.GameEvent_UIGuideExit, Hide);
        ...
        {
            //EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_UIGuideEnter, Show);
            //EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_UIGuideExit, Hide);
