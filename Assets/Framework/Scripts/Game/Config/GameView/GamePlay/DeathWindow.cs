...
namespace Thanos.View
{
    public class DeathWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NotifyDeathEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NotifyDeathExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NotifyDeathEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NotifyDeathExit, Hide);
        ...
        void CreateEffect()
        {
            if (Effect != null)
                return;
            ResourceItem EffectUnit = ResourcesManager.Instance.loadImmediate(path, ResourceType.PREFAB);
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroReborn, ExitDeath);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroReborn, ExitDeath);
        }
