...
namespace Thanos.View
{
    ...
    public class BattleInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_BattleInfoEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_BattleInfoExit, Hide);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_BattleInfoEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_BattleInfoExit, Hide);
...
//#endif
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerGoods, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerAssist, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerKills, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerDeaths, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerLevel, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_AllPlayerLastHit, Record);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroAttributesInfo,ShowMine);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerGoods, Record);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerAssist, Record);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerKills, Record);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerDeaths, Record);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerLevel, Record);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroAttributesInfo, ShowMine);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_AllPlayerLastHit, Record);
        }
