...
namespace Thanos.View
{
    public class RoomInviteWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomInviteEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomInviteExit, Hide);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RoomExit, Hide);
        }

        public override void Realse()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RoomInviteEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RoomInviteExit, Hide);
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_InviteList, ShowFriendOnLine);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_InviteList, ShowFriendOnLine);
        }
