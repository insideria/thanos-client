...
namespace Thanos.View
{
    public class TimeDownWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<long>((Int32)GameEventEnum.GameEvent_BattleTimeDownEnter, ShowTime);
            EventCenter.AddListener<long>((Int32)GameEventEnum.GameEvent_GameStartTime,Stop);
        }

        //类对象释放
        public override void Realse()
        {
            EventCenter.RemoveListener<long>((Int32)GameEventEnum.GameEvent_BattleTimeDownEnter, ShowTime);
            EventCenter.RemoveListener<long>((Int32)GameEventEnum.GameEvent_GameStartTime, Stop);
        }
