...
namespace Thanos.View
{
    public class HeroTimeLimitWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroTimeLimitEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroTimeLimitExit, Hide);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroTimeLimitEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroTimeLimitExit, Hide);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketExit, Hide);
        ...
        {
            EventCenter.AddListener<int>((Int32)GameEventEnum.GameEvent_RefreshTimeLimitHero, RefreshMarketHeroList);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SdkLogOff, SdkLogOff);
            EventCenter.AddListener<GuideTaskType, int>((Int32)GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishGuideTask);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>((Int32)GameEventEnum.GameEvent_RefreshTimeLimitHero, RefreshMarketHeroList);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SdkLogOff, SdkLogOff);
            EventCenter.RemoveListener<GuideTaskType, int>((Int32)GameEventEnum.GameEvent_PlayChildTaskFinish, OnFinishGuideTask);
        }
