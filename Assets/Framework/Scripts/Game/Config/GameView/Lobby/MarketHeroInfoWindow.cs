...
namespace Thanos.View
{
    public class MarketHeroInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketHeroInfoEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketHeroInfoExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketHeroInfoEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketHeroInfoExit, Hide);
        ...
        {
            EventCenter.AddListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroInfo);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroInfo);
        }
