...
namespace Thanos.View
{
    public class MarketRuneInfoWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<GameObject>((Int32)GameEventEnum.GameEvent_MarketRuneInfoEnter, InitRuneInfo);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketRuneInfoExit, Hide);
        }
        ...
        {
            EventCenter.RemoveListener<GameObject>((Int32)GameEventEnum.GameEvent_MarketRuneInfoEnter, ShowWhenRelease);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketRuneInfoExit, Hide);
        }
