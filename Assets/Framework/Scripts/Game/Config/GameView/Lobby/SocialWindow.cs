...
namespace Thanos.View{
    public class SocialWindow : BaseWindow {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SocialEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SocialExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SocialEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SocialExit, Hide);
        ...
        private void RemoveBlack(GameObject go)
        {
            ...
            {
                SGUID = FriendManager.Instance.OnClickKey[LastObj.objParent].GUID;
        ...
        {
            EventCenter.AddListener<UInt64>((Int32)GameEventEnum.GameEvent_RemoveFriendEnd, RemoveGrid);
            EventCenter.AddListener<UInt64>((Int32)GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
            EventCenter.AddListener<Friend>((Int32)GameEventEnum.GameEvent_CreateFriendPrefab, NewFriend);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_CreateBlackPrefab, NewBlack);
            EventCenter.AddListener<ErrorCodeEnum>((Int32)GameEventEnum.GameEvent_AskFriendEorr, EventError);
        }
        ...
        {
            EventCenter.RemoveListener<UInt64>((Int32)GameEventEnum.GameEvent_RemoveFriendEnd, RemoveGrid);
            EventCenter.RemoveListener<UInt64>((Int32)GameEventEnum.GameEvent_FriendChangeInfo, ChangeOnLine);
            EventCenter.RemoveListener<Friend>((Int32)GameEventEnum.GameEvent_CreateFriendPrefab, NewFriend);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_CreateBlackPrefab, NewBlack);
            EventCenter.RemoveListener<ErrorCodeEnum>((Int32)GameEventEnum.GameEvent_AskFriendEorr, EventError);
        }

        private void EventError(ErrorCodeEnum arg1)
        {
        ...
        void ShowOnLine(bool isOn, Dictionary<UInt64, Friend> temp, bool isVib = true)
        {
            ...
            foreach (var item in temp.Values)
            {
                ...
                {
                    ResourceItem objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadFriendUI, ResourceType.PREFAB);
