...
namespace Thanos.View
{
   //大厅战斗主界面，包括创建房间，加入房间， 匹配选择等
    public class BattleWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_BattleEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_BattleExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_BattleEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_BattleExit, Hide);
        ...
        protected override void InitWidget()
        {
            ...
            mMatChNormal = mRoot.Find("MatchInterface/BattleMode/Normal").GetComponent<UIToggle>();//一般匹配
            mMatChAi = mRoot.Find("MatchInterface/BattleMode/AI").GetComponent<UIToggle>();//人机对战
            //mMatchRank = mRoot.Find("MatchInterface/BattleMode/RankUp").GetComponent<UIToggle>();//天梯对战（隐藏了）
            mMatchMapGrid = mRoot.Find("MatchInterface/MapSelect/Grid");//圣光营地和奥斯深渊的父级
            ...
            UIGuideCtrl.Instance.AddUiGuideEventBtn(mMap2);//原先是注释的
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_BattleUpdateRoomList, UpdateRoomList);
            EventCenter.AddListener<ErrorCodeEnum>((Int32)GameEventEnum.GameEvent_AskFriendEorr, EventError);
            EventCenter.AddListener<ErrorCodeEnum>((Int32)GameEventEnum.AskAddInBattle, EventError);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_BattleUpdateRoomList, UpdateRoomList);
