...
namespace Thanos.View
{
    ...
    public class DaliyBonusWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_DailyBonusEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_DailyBonusExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_DailyBonusEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_DailyBonusExit, Hide);
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_DailyBonusUpdate, OnEvent_DailyBonusUpdate);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_InfiniteTaskUpdate);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NotifyDailyTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.AddListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskAdd, OnEvent_OneTaskAdd);
            EventCenter.AddListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskUpdate, OnEvent_OneTaskUpdate);
            EventCenter.AddListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskDel, OnEvent_OneTaskDel);
            EventCenter.AddListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskRewards, OnEvent_OneTaskRewards);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_DailyBonusUpdate, OnEvent_DailyBonusUpdate);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NotifyAllTaskUpdate, OnEvent_InfiniteTaskUpdate);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NotifyDailyTaskUpdate, OnEvent_DailyTaskUpdate);
            EventCenter.RemoveListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskAdd, OnEvent_OneTaskAdd);
            EventCenter.RemoveListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskUpdate, OnEvent_OneTaskUpdate);
            EventCenter.RemoveListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskDel, OnEvent_OneTaskDel);
            EventCenter.RemoveListener<CTask>((Int32)GameEventEnum.GameEvent_NotifyOneTaskRewards, OnEvent_OneTaskRewards);
        }
        ...
        private void OnDaliyGameObjsClick(GameObject obj)
        {
            ...
            EventCenter.Broadcast((Int32)GameEventEnum.GameEvent_PurchaseSuccessWindowEnter);
            int pos = -1;
            foreach (string itemStr in bonus.n32ItemID)
            {
                ...
                if (itemID == 1)
                {
                    EventCenter.Broadcast<EPurchaseType, string, string, int>((Int32)GameEventEnum.GameEvent_PurchaseRuneSuccessWin, 
