...
namespace Thanos.View
{
    public class SystemNoticeWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SystemNoticeEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_SystemNoticeExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SystemNoticeEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_SystemNoticeExit, Hide);
        ...
        void SetAllNotice()
        {
            ...
            {
                ResourceItem objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.LoadNoticeTitleUI, ResourceType.PREFAB);
