...
namespace Thanos.View
{
    ...
    public class PurchaseSuccessWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_PurchaseSuccessWindowEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_PurchaseSuccessWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_PurchaseSuccessWindowEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_PurchaseSuccessWindowExit, Hide);
        ...
        {
            EventCenter.AddListener<EPurchaseType, string, string, int>((Int32)GameEventEnum.GameEvent_PurchaseRuneSuccessWin, UpdatePurchase);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<EPurchaseType, string, string, int>((Int32)GameEventEnum.GameEvent_PurchaseRuneSuccessWin, UpdatePurchase);
        }
