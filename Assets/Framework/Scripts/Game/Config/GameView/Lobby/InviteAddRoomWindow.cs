...
namespace Thanos.View
{
    public class InviteAddRoomWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_InviteRoomEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_InviteRoomExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_InviteRoomEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_InviteRoomExit, Hide);
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_NewInviteRoom, ChangeInvite);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_NewInviteRoom, ChangeInvite);
        }
