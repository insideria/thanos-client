...
namespace Thanos.View
{
    public class HeroDatumWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroDatumEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_HeroDatumExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroDatumEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_HeroDatumExit, Hide);
        ...
        {
            EventCenter.AddListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, BuySuccess);
        }

        //游戏事件注消
        protected override void OnRemoveListener()
        {
            EventCenter.RemoveListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, BuySuccess);
        }
