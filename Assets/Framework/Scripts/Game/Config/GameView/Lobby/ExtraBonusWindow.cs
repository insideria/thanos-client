...
namespace Thanos.View
{
    public class ExtraBonusWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_ExtraBonusEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_ExtraBonusExit, Hide);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_GameSettingExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_ExtraBonusEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_ExtraBonusExit, Hide);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_GameSettingExit, Hide);
