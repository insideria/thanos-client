...
namespace Thanos.View
{
    public class MarketHeroListWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketHeroListEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketHeroListExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketHeroListEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketHeroListExit, Hide);
        ...
        {
            EventCenter.AddListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroList);
        ...
        {
            EventCenter.RemoveListener<int>((Int32)GameEventEnum.GameEvent_RefreshGoodHero, RefreshMarketHeroList);
