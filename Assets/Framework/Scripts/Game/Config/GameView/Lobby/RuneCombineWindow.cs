...
namespace Thanos.View
{
    ...
    public class RuneCombineWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RuneCombineWindowEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RuneCombineWindowExit, Hide);
                ...
                case RuneComposeState.step2:
                    {
                        ...
                        if (curTime - m_ComposeTime >= ComposeStateWaitTime[(int)m_RuneComposeState])
                        {
                            ...
                            EventCenter.Broadcast<EPurchaseType, string, string, int>((Int32)GameEventEnum.GameEvent_PurchaseRuneSuccessWin, EPurchaseType.EPT_Rune, cfg.RuneName, cfg.Icon, 1);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RuneCombineWindowEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RuneCombineWindowExit, Hide);
        ...
        public void onClickCombine()
        {
            ...
            HolyGameLogic.Instance.AskCombine(runeList);
        }
