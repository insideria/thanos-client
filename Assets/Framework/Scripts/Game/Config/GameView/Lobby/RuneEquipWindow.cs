...
namespace Thanos.View
{
    public class RuneEquipWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RuneEquipWindowEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RuneEquipWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RuneEquipWindowEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RuneEquipWindowExit, Hide);
        ...
        {
            EventCenter.Broadcast((Int32)GameEventEnum.GameEvent_RuneRefeshWindowEnter);
        }
        ...
        public void onClickSlot(GameObject go)
        {
            ...
            HolyGameLogic.Instance.SendUnloadRune(m_CurPageNum, pos);
        }
        ...
        {
            EventCenter.AddListener<uint, int, int>((Int32)GameEventEnum.GameEvent_RuneQuipUpdate, RefeshEquipRuneInfo);
            EventCenter.AddListener<int, int>((Int32)GameEventEnum.GameEvent_RuneQuipUnload, UnloadRune);
        ...
        {
            {
                ...
                ResourceItem objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.RuneSlotAddFlash, ResourceType.PREFAB);
        ...
        public void RefeshEquipRuneInfoWhenInit(uint runeid, int sPage, int slotPos)
        {
...

            {
                ...
                ResourceItem objUnit = ResourcesManager.Instance.loadImmediate(GameConstDefine.RuneSlotEquipLight, ResourceType.PREFAB);
                objLoad = GameObject.Instantiate(objUnit.Asset) as GameObject;
                objLoad.transform.parent = transFrom;
                objLoad.transform.localScale = Vector3.one;
                objLoad.transform.localPosition = Vector3.zero;
        ...
        {
            EventCenter.RemoveListener<uint, int, int>((Int32)GameEventEnum.GameEvent_RuneQuipUpdate, RefeshEquipRuneInfo);
            EventCenter.RemoveListener<int, int>((Int32)GameEventEnum.GameEvent_RuneQuipUnload, UnloadRune);
        ...
        public void onClickRuneCard(GameObject go)
        {
            ...
            for (int i = 0; i < GameDefine.GameConstDefine.MaxRuneSlot; ++i)
            {
                ...
                {
                    HolyGameLogic.Instance.AskEquipRune(runeID, 0);
