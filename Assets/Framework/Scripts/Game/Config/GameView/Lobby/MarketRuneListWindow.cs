...
namespace Thanos.View
{
    public class MarketRuneListWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketRuneListEnter, Show);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketRuneListExit, Hide);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_MarketExit, ParentClose);
        }
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketRuneListEnter, Show);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketRuneListExit, Hide);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_MarketExit, ParentClose);
            runeListObjects.Clear();
        }
