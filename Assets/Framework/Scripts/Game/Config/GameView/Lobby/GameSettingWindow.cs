...
namespace Thanos.View
{
    public class GameSettingWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_GameSettingEnter, Show);
        ...
        {
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_GameSettingEnter, Show);
