...
namespace Thanos.View
{
    public class RuneBuyWindow : BaseWindow
    {
        ...
        {
            EventCenter.AddListener<GameObject>((Int32)GameEventEnum.GameEvent_RuneBuyWindowEnter, InitRuneInfo);
            EventCenter.AddListener((Int32)GameEventEnum.GameEvent_RuneBuyWindowExit, Hide);
        ...
        {
            EventCenter.RemoveListener<GameObject>((Int32)GameEventEnum.GameEvent_RuneBuyWindowEnter, InitRuneInfo);
            EventCenter.RemoveListener((Int32)GameEventEnum.GameEvent_RuneBuyWindowExit, Hide);
