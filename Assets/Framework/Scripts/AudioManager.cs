    ...
    public class AudioManager : Singleton<AudioManager>{
		...
		public void GetMoneyAudio () {
			if (GetMoney == null) {
				...
				ResourceItem GetMoneyUnit = ResourcesManager.Instance.loadImmediate (AudioDefine.PATH_GETMONEY, ResourceType.ASSET);
				GetMoney = UnityEngine.Object.Instantiate(GetMoneyUnit.Asset) as AudioClip;                                    
			}
		...
		public void PlatUnloadRuneAudio () {
			ResourceItem res = ResourcesManager.Instance.loadImmediate (AudioDefine.PATH_UnloadRune, ResourceType.ASSET);
