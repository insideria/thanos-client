...
namespace ProtoBuf.Compiler
{
    ...
    internal class CompilerContext
    {
        ...
        public static MessageDecodeerializer BuildDeserializer(IProtoSerializer head, TypeModel model)
        {
            Type type = head.ExpectedType;
            ...
            ctx.Emit(OpCodes.Ret);
            return (MessageDecodeerializer)ctx.method.CreateDelegate(
                typeof(MessageDecodeerializer));
        }
#endif
